                            ...
                            <DialogBody mb={0}>
                                <VStack>
                                    ...
                                    <Field.Root style={{ display: 'flex', flexDirection: 'row' }}>
                                        ...
                                        <NativeSelectRoot
                                            borderRadius="md" border={"1px"} borderColor={"#666666"} mt={2} w={"100px"} bg="white">
                                            <NativeSelectField size="sm"
                                                value={selectedTicket.status} // ตั้งค่า value เพื่อให้แสดงค่าปัจจุบัน
                                                onChange={e => setSelectedTicket({ ...selectedTicket, status: e.target.value })} // ใช้ onChange เพื่ออัปเดตค่า
                                            >
                                                <option value="Pending">Pending</option>
                                                <option value="Accepted">Accepted</option>
                                                <option value="Resolved">Resolved</option>
